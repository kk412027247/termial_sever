...
getListSchema.plugin(mongooseToCsv, {
  ...
  constraints: {
    ...
    '支持TD-SCDMA频段':'支持TD-SCDMA频段',
    '支持WCDMA频段':'支持WCDMA频段',
    '支持FDD-LTE频段':'支持FDD-LTE频段',
    "终端支持能力":"终端支持能力",
    "终端支持能力子项":"终端支持能力子项",
    "是否智能机":"是否智能机",
    "是否支持FR":"是否支持FR",
...
module.exports = mongoose.model('terminal',getListSchema,'info');
